...
DEFINE_COMMAND_PLUGIN(GetLifeState, , true, nullptr);
...
DEFINE_CMD_ALT_COND_PLUGIN(GetBaseScale, GetBasedScale, , true, nullptr);
...
DEFINE_COMMAND_PLUGIN(IsRadioRefPlaying, , true, nullptr);
